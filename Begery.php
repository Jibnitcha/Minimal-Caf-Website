...
<head>
    ...
    <link rel="stylesheet" href="MainBegery.css">
    <title>BEGERY</title>
    <style>
...
<body>
    ...
    <script>
        ...
        const imageData = [
            { src: 'Banana chocolate-ship.png', caption: 'Banana chocolate chip', link: 'BegeryBananaChocChipMuffin.php' },
            { src: 'Almond cream croissant.png', caption: 'Almond cream croissant', link: 'BegeryAlmondCreamCroissant.php' },
            { src: 'Custard cream mochi waffle.png', caption: 'Custard cream mochi waffle', link: 'BegeryCustardCreamMochiWaffle.php' },
            { src: 'French butter croissant.png', caption: 'French butter croissant', link: 'BegeryFrenchButterCroissant.php' },
            { src: 'skinny blueberry muffin.png', caption: 'Skinny blueberry muffin', link: 'BegerySkinnyBlueberrMuffin.php' },
            { src: 'Chocolate chip cookie.png', caption: 'Soft Chocolat Chip Cookie', link: 'BegerySoft%20ChocolatChipCookie.php' }
        ];
