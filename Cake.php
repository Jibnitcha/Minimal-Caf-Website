...
<head>
    ...
    <link rel="stylesheet" href="MainCake.css">
...
<body>
    ...
    <script>
        ...
        const imageData = [
            { src: 'Basque Cheese Cake.png', caption: 'Basque Cheese Cake', link: 'CakeBasqueCheeseCake.php' },
            { src: 'Blueberry Cheesecake.png', caption: 'Blueberry Cheesecake', link: 'CakeBlueberryCheesecake.php' },
            { src: 'Banoffee Pie.png', caption: 'Banoffee Pie', link: 'CakeBanoffeePie.php' },
            { src: 'Coconut Cake.png', caption: 'Coconut Cake', link: 'CakeCoconut.php' },
            { src: 'Chocolate Cake.png', caption: 'Chocolate Cake', link: 'CakeChocolate.php' },
            { src: 'Espresso ChocChip Brownie.png', caption: 'Espresso ChocChip Brownie', link: 'CakeEspressoChocchip.php' }
        ];
