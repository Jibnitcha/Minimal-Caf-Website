...
<head>
    ...
    <link rel="stylesheet" href="MainSoda&Smoothie.css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
        <link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap" rel="stylesheet">
    <title>Soda&Smoothie</title>
...
<body>
    ...
    <h1><center>Soda & Smoothie</center></h1>
    ...
    <script>
        ...
        const imageData = [
            { src: 'Ice lemon soda.png', caption: 'Ice Lemon Soda', link: 'SodaIceLemonSoda.php' },
            { src: 'Strawberry soda.png', caption: 'Strawberry Soda', link: 'SodaStrawberrySoda.php' },
            { src: 'Ume soda.png', caption: 'Ume Soda', link: 'SodaUmeSoda.php' },
            { src: 'watermelon smoothie.png', caption: 'Watermelon Smoothie', link: 'Smoothiewatermelon.php' },
            { src: 'Strawberry smoothei.png', caption: 'Strawberry Smoothei', link: 'SmoothieStrawberry.php' },
            { src: 'Mix berries smoothie.png', caption: 'Mix berries smoothie', link: 'SmoothieMixberry.php' }
        ];
